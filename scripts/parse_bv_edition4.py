...
LANG = {
    'Et blekt lys lyder': '器乐',   # 器乐曲（标题挪威语）
    'Je Rêverai à Toi': '法语',
    '暖': '中文',
    'Perfume (feat. Weste & Fedrico Estevez)': '西班牙语',
    'Farlig': '挪威语',
    'Rush Hour': '器乐',            # Herlin Riley 器乐曲
...
def main():
    ...
    data = {
        ...
        'city': '', 'host': '', 'motto': '',
        'summary': '第四届吧视，参赛歌曲按受众分 A 组（小众单曲）/ B 组（中等受众单曲）两组，独立计分与排名。混淆曲为非正式项目、不计入排名。A 组投票人泰妈仅给出前五喜好（12/10/8/7/6），计分按 50% 折算。投票沿用欧视制 Top10。',
        'rules': {
