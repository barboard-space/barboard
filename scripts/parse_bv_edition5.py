...
def main():
    ...
    data = {
        ...
        'summary': summary,
        'rules': {
            'submission': '针对 lead 艺人分 A（小众）/ B（中众）/ C（大众）三组报名，发行时间 2016.1.1–2019.10；每组设 2 个混淆项名额（先报先得、每人最多 1 首）。大众组提倡报小众单曲、不提倡家喻户晓的歌。报名私戳雨妈并对所报歌曲保密。',
            'niche_standard': [
                'A 小众｜云村评论≤500·收藏≤5000·Spotify 月听众≤2.5M/单曲≤5M·YT 订阅≤2.5M/MV≤7.5M·BB·UK 最高≤100·MT 进榜≤5',
                'B 中众｜评论≤1000·收藏≤25000·月听众≤5M/单曲≤25M·YT≤5M/MV≤50M·BB·UK≤50·MT≤10',
                'C 大众｜评论≤2500·收藏≤50000·月听众≤10M/单曲≤50M·YT≤10M/MV≤100M·BB·UK≤10·MT≤15',
                'lead 艺人无格莱美四大通类提名；不得有吧半年榜/年榜 Top100 单曲（C 组 Top50）',
                'feat 艺人不得有 BB Hot100/UK：A 组 Top50 或在榜>20 周 · B 组 Top10 或>40 周 · C 组 冠单 或>52 周',
            ],
            'format': 'A、B、C 三组分开比赛、独立计分与排名，最终成绩不综合各组。混淆项参与评分但不计入最终排名。',
            'voting': '欧视制，每位评委提交 Top10（12/10/8/7/6/5/4/3/2/1）；选送者互投为 Jury、其余观众为 Tele。报名参赛的评委必须提交排名，否则其歌曲取消最终排名资格。',
        },
