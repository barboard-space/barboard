(function () {
  ...
  var NAV_HTML = [
    ...
    '    <ul class="nav__links">',
    '      <li><a href="/barvision/">Barvision</a></li>',
    '      <li><a href="/bbl/">BarboardLab</a></li>',
    ...
    '      <li><a href="/barvision/2026/events/" class="nav__cta"><span class="nav__cta-title">Barvision 2026</span><span class="nav__cta-sub">歌曲报名</span></a></li>',
    '    </ul>',
  ...
  var FOOTER_HTML = [
    ...
    '          <li><a href="/bbl/">关于 BarboardLab</a></li>',
    '          <li><a href="/bbl/hof/">Hall of Fame</a></li>',
    ...
    '        <ul class="footer__links">',
    '          <li><a href="/barvision/2026/events/">Barvision 2026</a></li>',
    '          <li style="display:none"><a href="/barvision/2025/events/">Barvision 2025</a></li>',
    '          <li><a href="/barvision/hof/">Hall of Fame</a></li>',
    '          <li><a href="/barvision/stats/">数据中心</a></li>',
    '          <li><a href="/barvision/">历届回顾</a></li>',
    '        </ul>',
    '      </div>',
    '      <div>',
    '        <div class="footer__col-title">更多</div>',
    '        <ul class="footer__links">',
    '          <li><a href="/about/">关于 Barboard</a></li>',
    '          <li><a href="/archive/">Archive</a></li>',
    '          <li><a href="/member/">Members</a></li>',
    '        </ul>',
    '      </div>',
    ...
    '      <span class="footer__notice">Designed & Built by <a class="member" href="/member/7/" data-nickname="威妈">@williw_</a></span>',
    '    </div>',
    '  </div>',
    '</footer>'
  ].join('\n');
