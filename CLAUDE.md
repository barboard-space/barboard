...
174. **⭐ 榜吧年终榜导入（2022 样板已完成，进行中）**：把旧「吧年榜」(2013–2024 存档活动) 建成类 BBL 榜单页，逐年导入。
    ...
    - **入口**：`archive/index.html` 的「榜吧年榜」卡链接「2022 年终榜」→ `/archive/annual/2022/`。
    ...
    - **下一步**：① 排行榜功能细化呈现；② **年榜助攻数据同步到成员个人主页**（成员页加「年榜」板块或在现有结构展示其上榜单曲/助攻——需设计数据聚合：从 `data/annual/*.json` 按艺人/成员归集，注意年榜是「歌手」维度、成员页是「选送大妈」维度，两者映射关系待与用户厘清）。剩余：封面命中率优化、铺 2013–2021 其它年份。
